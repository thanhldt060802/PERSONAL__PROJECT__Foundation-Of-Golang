...
func NewDistributedSystemHandleTask(DispatcherNodeName string, ReceiverNodeName string) *DistributedSystemHandleTask {
...
func (app *DistributedSystemHandleTask) initReceiverNode() {
	...
	receiverSupervisorPID, _ := app.receiverNode.Spawn(FactoryReceiverSupervisor, gen.ProcessOptions{})
